...
class _$GoogleAuthenticationLoadingImpl<T>
  ...
  @override
  String toString() {
    return 'SignUpState<$T>.googleAuthenticationLoading()';
  }
...
abstract class GoogleAuthenticationLoading<T> implements SignUpState<T> {
...
class _$GoogleAuthenticationSuccessImpl<T>
  ...
  @override
  String toString() {
    return 'SignUpState<$T>.googleAuthenticationSuccess(data: $data)';
  }
...
abstract class GoogleAuthenticationSuccess<T> implements SignUpState<T> {
...
class _$GoogleAuthenticationErrorImpl<T>
  ...
  @override
  String toString() {
    return 'SignUpState<$T>.googleAuthenticationFailure(apiErrorModel: $apiErrorModel)';
  }
...
abstract class GoogleAuthenticationError<T> implements SignUpState<T> {
